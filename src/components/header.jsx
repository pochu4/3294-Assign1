    ...
    return (
        ...
        <header className="flex justify-between items-center drop-shadow-md text-white py-6 px-8 md:px-32 m-auto border-b-8 border-yellow-600 bg-yellow-600">
            ...
            <ul className="hidden xl:flex items-end gap-12 font-semibold text-white">
                <li className="p-3 rounded-3xl hover:bg-yellow-300 hover:text-black transition-all cursor-pointer">HOME</li>
                <li className="p-3 rounded-3xl hover:bg-yellow-300 hover:text-black transition-all cursor-pointer">SHOP</li>
                <li className="p-3 rounded-3xl hover:bg-yellow-300 hover:text-black transition-all cursor-pointer">ABOUT</li>
            </ul>
